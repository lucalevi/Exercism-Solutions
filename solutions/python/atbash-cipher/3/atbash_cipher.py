...
def encode(plain_text):
    ...
    # filtered_text = "".join(char for char in plain_text.lower() if char.isalnum())

    # Encode the filtered text using the Atbash cipher
    encoded_text = plain_text.translate(atbash_cipher)
...
def decode(ciphered_text):
    ...
    """
    # Normalize the input text to lowercase and filter out non-alphanumeric characters
    # filtered_text = "".join(char for char in ciphered_text.lower() if char.isalnum())
