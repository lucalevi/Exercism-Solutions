...
def recite(start_verse: int, end_verse: int) -> list[str]:
    """
    Recite the verses of "The House That Jack Built" nursery rhyme.
    :param start_verse: The starting verse number (1-indexed).
    :param end_verse: The ending verse number (1-indexed).
    :return: A list of verses from the nursery rhyme.
    """
    return RHYME[start_verse - 1 : end_verse] if start_verse <= end_verse else []
